    ...
    <div className="w-full flex justify-center pb-6">
      <div className="w-full lg:w-[800px] flex flex-col gap-y-6">
        <div className="rounded-lg w-full shadow-soft p-6 flex flex-col gap-y-6 bg-white">
          <h1 className="text-[20px] font-bold">Edit Tarif Alat Kesehatan</h1>
          ...
          <div className="flex gap-x-6">
            <div className="flex flex-col  w-1/2 gap-y-4">
              ...
              <TextField label="Merek" required />
              <TextField label="Tahun Pembelian" required />
            ...
            <div className="flex w-1/2 flex-col  gap-y-4">
              ...
              <TextField label="Lokasi" required />
              <TextField label="Status" required />
      ...
      >
        <div className="w-ful py-8 flex flex-col">
          <h5 className="text-[20px] font-bold text-[#31475E] text-center">
            Apakah Anda yakin ingin mengubah tarif alat kesehatan?
          </h5>
